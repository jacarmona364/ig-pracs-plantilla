...
public:
   // Constructor: crea el perfil original y llama a inicializar
   // La esfera tiene el centro en el origen, el radio es la unidad
   SemiEsfera(const int num_verts_per,   // número de vértices del perfil original (M)
          const unsigned nperfiles // número de perfiles (N)
   );
};

class Piramide : public MallaRevol
{
public:
   // Constructor: crea el perfil original y llama a inicializar
   // La Piramide tiene el centro en el origen, la altura es la unidad
   Piramide(const int num_verts_per,   // número de vértices del perfil original (M)
          const unsigned nperfiles // número de perfiles (N)
   );
};
