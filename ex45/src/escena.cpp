...
Escena::Escena()
{
   ...
   /**
    * @brief Una cámara con proyección perspectiva, situada en la posición (0, 0, 5), mirando hacia el origen (0, 0, 0), y con un ángulo de apertura vertical de 60 grados.
    * Otra cámara con proyección ortográfica, situada en la posición (5, 0, 0), mirando hacia el origen (0, 0, 0), y también con un ángulo de apertura vertical de 60 grados.
    * Una tercera cámara con proyección perspectiva, situada en la posición (0, 5, 0), mirando hacia el origen (0, 0, 0), y con un ángulo de apertura vertical de 60 grados.
    */
...
Escena2::Escena2()
{
   ...
   objetos.push_back( new Piramide(5, 5) );
   objetos.push_back( new Esfera(200, 200) );
   ...
   // AÑADIR CILINDRO, CONO Y ESFERA.
   objetos.push_back( new Cilindro(12, 24) );
   objetos.push_back( new Cono(12, 24) );
...
Escena3::Escena3()
{
   ...
   objetos.push_back( new GrafoPiramides(3.0, 0.0) );
   objetos.push_back( new GrafoEstrellaX(2.5, 8));
   objetos.push_back( new GrafoCubos(2.5, 5, 5));
   objetos.push_back( new Cohete(4.0, 360.0, -90.0) );
