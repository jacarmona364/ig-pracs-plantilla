...
class EstrellaCuatroPuntas : public MallaInd
{
   public:
      EstrellaCuatroPuntas();
};

// ---------------------------------------------------------------------

class EstrellaOchoPuntas : public MallaInd
{
   public:
      EstrellaOchoPuntas();
};
...
{
   public:
      RejillaY(const unsigned n, const unsigned m);
};
